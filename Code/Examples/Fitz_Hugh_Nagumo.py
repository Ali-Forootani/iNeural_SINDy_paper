...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 28 16:20:34 2022
...
list_initial_conditions = [[2, 1.5], [1.5, 2]]
    ...
    for k in range(len(param_set.useRK)):
        for j in range(len(param_set.useNN)):
            if param_set.useRK[k] == False and param_set.useNN[j] == False:
                ...
                print(
                    model.estimated_coeffs_k.linear.weight.detach()
                    .clone()
                    .t()
                    .cpu()
                    .numpy()
...
"""Ploting the simulation results corresponding to different algorithms"""
...
axs[0].set_ylim((-1.1, 1.7))

axs[1].set_xlim((-2.2, 2.2))
axs[1].set_ylim((-1.1, 1.7))

axs[2].set_xlim((-2.2, 2.2))
axs[2].set_ylim((-1.1, 1.7))
...
# fig.suptitle("Fitz-Hugh Nagumo", fontsize=30, y=0.92)

axs[0].plot(
    track_coef_matrix_1_NNRK[:10000, 1],
    color=colors[0],
    marker="^",
    linestyle="-",
    markersize=10,
...
axs[0].plot(
    track_coef_matrix_1_RK[:10000, 1],
    color=colors[2],
    marker="8",
    linestyle="--",
    markersize=10,
...
axs[0].plot(
    track_coef_matrix_1_NN[:10000, 1],
    color=colors[3],
    marker="s",
    linestyle="-.",
    markersize=10,
...
axs[1].plot(
    track_coef_matrix_1_NNRK[:10000, 2],
    color=colors[0],
    marker="^",
    linestyle="-",
    markersize=10,
...
axs[1].plot(
    track_coef_matrix_1_RK[:10000, 2],
    color=colors[2],
    marker="8",
    linestyle="--",
    markersize=10,
...
axs[1].plot(
    track_coef_matrix_1_NN[:10000, 2],
    color=colors[3],
    marker="s",
    linestyle="-.",
    markersize=10,
...
axs[2].plot(
    track_coef_matrix_2_NNRK[:10000, 1],
    color=colors[0],
    marker="^",
    linestyle="-",
    markersize=10,
...
axs[2].plot(
    track_coef_matrix_2_RK[:10000, 1],
    color=colors[2],
    marker="8",
    linestyle="--",
    markersize=10,
...
axs[2].plot(
    track_coef_matrix_2_NN[:10000, 1],
    color=colors[3],
    marker="s",
    linestyle="-.",
    markersize=10,
...
axs[3].plot(
    track_coef_matrix_2_NNRK[:10000, 2],
    color=colors[0],
    marker="^",
    linestyle="-",
    markersize=10,
...
axs[3].plot(
    track_coef_matrix_2_RK[:10000, 2],
    color=colors[2],
    marker="8",
    linestyle="--",
    markersize=10,
...
axs[3].plot(
    track_coef_matrix_2_NN[:10000, 2],
    color=colors[3],
    marker="s",
    linestyle="-.",
    markersize=10,
...
axs[0].plot(
    track_coef_matrix_1_NNRK[:10000, 0],
    color=colors[0],
    marker="^",
    linestyle="-",
    markersize=10,
...
axs[0].plot(
    track_coef_matrix_1_RK[:10000, 0],
    color=colors[2],
    marker="8",
    linestyle="--",
    markersize=10,
...
axs[0].plot(
    track_coef_matrix_1_NN[:10000, 0],
    color=colors[3],
    marker="s",
    linestyle="-.",
    markersize=10,
...
axs[1].plot(
    track_coef_matrix_1_NNRK[:10000, 6],
    color=colors[0],
    marker="^",
    linestyle="-",
    markersize=10,
...
axs[1].plot(
    track_coef_matrix_1_RK[:10000, 6],
    color=colors[2],
    marker="8",
    linestyle="--",
    markersize=10,
...
axs[1].plot(
    track_coef_matrix_1_NN[:10000, 6],
    color=colors[3],
    marker="s",
    linestyle="-.",
    markersize=10,
